...
1. Install Greasemonkey/TamperMonkey Extension for your specific browser. Follow only step 1 at: [https://greasyfork.org](https://greasyfork.org)
   ...
   - For Computer, Firefox with Greasemonkey is recommended. Chrome requires extra steps. You must right click Tampermonkey icon, click manage, and turn on "Allow User Scripts". If use tampermonkey, you will also need to click "Always Allow" when run for first time.
